...
Project stack: Nuxt 4 (SSR enabled), Node 24, pnpm (default), Drizzle ORM, PostgreSQL, Nuxt UI v4, Tailwind CSS v4, an OpenAI-compatible AI gateway, vitest, i18n (NL default + EN).
