...
2. **List constraints**: Nuxt SSR (universal: guard browser APIs with `import.meta.client`), Drizzle ORM (migrations required), Nuxt UI v4 (use before custom), i18n (NL + EN), vitest (2-min timeout), OpenAI-compatible AI gateway
