...
- **AI gateway** (any OpenAI-compatible endpoint) for AI model access via the URL configured in `NUXT_AI_GATEWAY_URL` — see this project's `.env` for which gateway it uses
